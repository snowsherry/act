...
export  const baseUrlMission=process.env.VUE_APP_API_MISSION;
export  const baseUrlCoin=process.env.VUE_APP_API_COIN;
export  const baseUrlStock=process.env.VUE_APP_API_STOCK;
export  const baseUrlChallenge=process.env.VUE_APP_API_CHALLENGE;
export  const baseUrlAccount=process.env.VUE_APP_API_ACCOUNT;
export  const baseUrlSchool=process.env.VUE_APP_API_SCHOOL;
